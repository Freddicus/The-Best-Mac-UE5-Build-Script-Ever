...
###
### NOTE: This script is intended to be configured via `.env`, environment variables, and/or CLI flags.
###       You generally should NOT need to edit the script.
### ============================================================================
...
require_not_placeholder() {
  ...
  if is_placeholder "$value"; then
    ...
    die "$name is not configured. Set it via .env / environment variable, or provide a CLI flag override. Hint: $hint"
  fi
}
...
Options (override .env / environment variables):
  --repo-root PATH
